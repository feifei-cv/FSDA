...
class RefineAction_ASF(nn.Module):
    def __init__(self, num_layers, r1, r2, num_f_maps, input_dim, num_classes, att_type='sliding_att', alpha=1):
        super(RefineAction_ASF, self).__init__()
        self.conv_1x1 = nn.Conv1d(input_dim, num_f_maps, 1)
        self.layers = nn.ModuleList(
            [AttModule(2 ** i, num_f_maps, num_f_maps, r1, r2, att_type, 'decoder', alpha) for i in #
             range(num_layers)])
        self.conv_out = nn.Conv1d(num_f_maps, num_classes, 1)
